...
class ExportPDFComponent extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Select parameters to generate and export ${"Export P D F".replaceAll('Export ', '')} report:"),
            ...
            ElevatedButton.icon(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text("Export P D F download started")),
                );
              },
